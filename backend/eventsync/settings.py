...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': (
        # Permite autenticação via Header (Bearer token)
    ...
    'EXCEPTION_HANDLER': 'eventsync.utils.custom_exception_handler',
}
...
REST_AUTH = {
    ...
    'USER_DETAILS_SERIALIZER': 'core.serializers.UserUpdateSerializer'
}
